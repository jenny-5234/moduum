...
<div class="navbar_Menu">
    <ul class="menu01">
        <li class="top-menu1" style="width: 20%; "><span><a href="../"><img src="/image/homeImages/modum-logo.png" style="width: 100%;"></a></span>
            <ul class="dept01" style="width: 20%">
                <li class="dept01_li"><a class="sub-menu">  </a></li>
            </ul>
        </li>
        <li>
        ...
        <li class="top-menu" style="width: 16%"><span><a class="main-menu">현황</a></span>
            <ul class="dept01" style="width: 16%">
                <li class="dept01_li"><a class="sub-menu" href="#">현황</a></li>
                <li class="dept01_li"><a class="sub-menu" href="#">분석 및 예측</a></li>

            </ul>
        </li>
        <li class="top-menu" style="width: 16%"><span><a class="main-menu" href="/map/mapsearch">가맹점 찾기</a></span>
            <ul class="dept01" style="width: 16%">
                <li class="dept01_li"><a href="/map/mapsearch"> <img src="/image/homeImages/map01.png"
                                                                     class="mapImage"/></a></li>
            </ul>
        </li>
